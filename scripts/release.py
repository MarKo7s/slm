#!/usr/bin/env python3
"""Tag and push an slm release from pyproject.toml version."""
...
REPOSITORY_URL = "https://github.com/MarKo7s/slm.git"
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "(prepended with 'Release slm {version}')"
        ),
    )
    parser.add_argument(
        "--dry-run",
    ...
    print("Install with:")
    print(
        f'  pip install "slm[notebooks] @ git+{REPOSITORY_URL}@{tag}"'
    )
